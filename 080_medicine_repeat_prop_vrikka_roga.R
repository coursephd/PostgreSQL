...
fwrite(cum02all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_repeat_prop_vrikka.csv")
fwrite(cum03all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_repeat_prop_cumulative_vrikka.csv")
...
keep <- c("mr_no", "studyday", "patient_gender", "baseage", "age", "Code", "description", 
          "Coded_med", "Type_med", "VrikkaRoga", "vis", "season", "newdt0", "distype")
...
fwrite(all_met_rmsd_unq03, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_all_met_rmsd_prop_vrikka.csv")
...
all_met_rmsd_unq05 <- all_met_rmsd_unq03 [grpday > 0, (list( cumday = (grpday: grpmaxday) ) ), 
                                          by = .(mr_no, presc, prescdis, Type_med, Coded_med, 
                                                 Code, description, baseage, age, VrikkaRoga, 
...
fwrite(a01all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_repeat_prop_cumulative_Rcal_vrikka.csv")

saveRDS (a01all, "D:/Hospital_data/ProgresSQL/analysis/080_medicine_repeat_prop_cumulative_Rcal_vrikka.rds")
...
fwrite(dismed02, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_bymr_no_dismed_comb_Rcal_vrikka.csv")

saveRDS (dismed02, "D:/Hospital_data/ProgresSQL/analysis/080_medicine_bymr_no_dismed_comb_Rcal_vrikka.rds")
