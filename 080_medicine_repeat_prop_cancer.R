...
all_met_rmsd <- readRDS("D:/Hospital_data/ProgresSQL/analysis/01adsl_cancer.rds")
...
fwrite(cum02all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_repeat_prop_cancer.csv")
fwrite(cum03all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_repeat_prop_cumulative_cancer.csv")
...
keep <- c("mr_no", "studyday", "patient_gender", "baseage", "age", "Code", "description", 
          "Coded_med", "Type_med", "Cancer", "vis", "season", "newdt0", "distype")
...
fwrite(all_met_rmsd_unq03, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_dis_all_met_rmsd_prop_cancer.csv")
...
all_met_rmsd_unq05 <- all_met_rmsd_unq03 [grpday > 0, (list( cumday = (grpday: grpmaxday) ) ), 
                                          by = .(mr_no, presc, prescdis, Type_med, Coded_med, 
                                                 Code, description, baseage, age, Cancer, 
...
fwrite(a01all, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_repeat_prop_cumulative_Rcal_cancer.csv")

saveRDS (a01all, "D:/Hospital_data/ProgresSQL/analysis/080_medicine_repeat_prop_cumulative_Rcal_cancer.rds")
...
fwrite(dismed02, 
       "D:/Hospital_data/ProgresSQL/analysis/080_medicine_bymr_no_dismed_comb_Rcal_cancer.csv")

saveRDS (dismed02, "D:/Hospital_data/ProgresSQL/analysis/080_medicine_bymr_no_dismed_comb_Rcal_cancer.rds")
