...
######################################################
# Program name: 100_adsl_v263_roga_bfr_aftr.R
# Output files: 01adsl_v263_roga_bfr_aftr.csv, 01adsl_v263_roga_bfr_aftr.rds
# Create calculations using base01_ip and base01_op
# 
# Keep only reference diseases which is V263Roga.
...
all_met_rmsd02 <- all_met_rmsd02 [, c("mr_no", "Code", "description", "mindayV263Roga", "V263Roga",
                                      "newdt0", "studyday", "mindisday", "Type_med", "Coded_med",
...
saveRDS (all_met_rmsd02, "D:/Hospital_data/ProgresSQL/analysis_v263/01adsl_v263_roga_bfr_aftr.rds")
...
fwrite(all03, "D:/Hospital_data/ProgresSQL/analysis_v263/01adsl_v263_roga_bfr_aftr_cat.csv")
saveRDS (all03, "D:/Hospital_data/ProgresSQL/analysis_v263/01adsl_v263_roga_bfr_aftr_cat.rds")
...
##########################################################################
# Keep only reference diseases which is VrikkaRoga.
# Remove all other reference dieases as they may not be of interest
# distype = VrikkaRoga
###########################################################################
# tolower(distype) == "v263roga"
all_met_rmsd03 <- all_met_rmsd02 [, -c("min", "max"),]

saveRDS (all_met_rmsd03, "D:/Hospital_data/ProgresSQL/analysis_v263/01adsl_v263_roga_bfr_aftr.rds")
fwrite(all_met_rmsd03, "D:/Hospital_data/ProgresSQL/analysis_v263/01adsl_v263_roga_bfr_aftr.csv")
