...
section_field_options <- fread("D:/Hospital_data/ProgresSQL/data_chk/section_field_desc.csv")
...
base01_other02 <- unique ( base01_other02 [, c("mr_no", "patient_id", "section_id",  "field_id", "option_remarks", "section_title", "display_order", "field_name"), with =FALSE] )

# Sort the data by patient and visits
#base01_other02 <- base01_other02 [ order(mr_no, patient_id, section_id, option_id, field_id)]
base01_other02 <- base01_other02 [ order(mr_no, patient_id, section_id, field_id)]

# Do the clean-up where the variable name is not present
base01_other03 <- base01_other02 [ nchar(field_name) > 0]
base01_other04 <- base01_other02 [ field_id < 0]
