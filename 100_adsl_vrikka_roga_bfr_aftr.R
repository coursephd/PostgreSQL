...
######################################################
# Program name: 100_adsl_vrikka_roga_bfr_aftr.R
# Output files: 01adsl_vrikka_roga_bfr_aftr.csv, 01adsl_vrikka_roga_bfr_aftr.rds
...
all_met_rmsd02 <- all_met_rmsd02 [, c("mr_no", "Code", "description", "mindayVrikkaRoga", "VrikkaRoga",
...
saveRDS (all_met_rmsd02, "D:/Hospital_data/ProgresSQL/analysis/01adsl_vrikka_roga_bfr_aftr.rds")
