...
######################################################
# Program name: 100_adsl_cancer_bfr_aftr.R
# Output files: 01adsl_cancer_bfr_aftr.csv, 01adsl_cancer_bfr_aftr.rds
# Create calculations using base01_ip and base01_op
# 
# Keep only reference diseases which is Cancer.
...
all_met_rmsd02 <- all_met_rmsd02 [, c("mr_no", "Code", "description", "mindayCancer", "Cancer",
...
saveRDS (all_met_rmsd02, "D:/Hospital_data/ProgresSQL/analysis/01adsl_cancer_bfr_aftr.rds")
