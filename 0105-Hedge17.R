...
bnkexp03 <- unique( na.omit( bnkexp02 [ nrow %in% c(4, 5), c("SYMBOL", "EXPIRY_DT", "strk", "nrow"), ]) )
bnkexp03 <- bnkexp03 [, `:=`(strk1 = strk + 1300, strk2 = strk + 1400, strk3 = strk + 1500, strk4 = strk + 1600, strk5 = strk + 1700), ]
