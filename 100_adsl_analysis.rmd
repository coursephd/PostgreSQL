...
kable(age02vismet [order(get, get.1)], caption = "Metabolic: Summary statistics of baseline age in years") 

kable(age02visrmsd [order(get, get.1)], caption = "RMSD: Summary statistics of baseline age in years") 
