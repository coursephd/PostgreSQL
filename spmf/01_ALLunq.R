...
fwrite(x = all_met_rmsd06 [, c("combdis02"),], 
       col.names = FALSE,
       file = "D:/Hospital_data/ProgresSQL/analysis_spmf/01input_SPADE_ALLunq.txt")
...
fwrite(x = all_met_rmsd06_arff [, c("combdis02"),], 
       col.names = FALSE,
       file = "D:/Hospital_data/ProgresSQL/analysis_spmf/01input_ARFF_ALLunq.txt")



out <- fread("D:/Hospital_data/ProgresSQL/analysis_spmf/01output_ARFF_TopKRules_ALLunq.txt", 
             sep ="!",
             header = FALSE)
...
fwrite(out9, "D:/Hospital_data/ProgresSQL/analysis_spmf/01input_ARFF_ALLunq_formatted.txt")
