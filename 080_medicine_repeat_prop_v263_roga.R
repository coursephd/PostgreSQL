...
fwrite(cum02all, 
       "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_dis_repeat_prop_v263_roga.csv")
fwrite(cum03all, 
       "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_dis_repeat_prop_cumulative_v263_roga.csv")
...
keep <- c("mr_no", "studyday", "patient_gender", "baseage", "age", "Code", "description", 
          "Coded_med", "Type_med", "V263Roga", "vis", "season", "newdt0", "distype")
...
fwrite(all_met_rmsd_unq03, 
       "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_dis_prop_v263_roga.csv")
...
all_met_rmsd_unq05 <- all_met_rmsd_unq03 [grpday > 0, (list( cumday = (grpday: grpmaxday) ) ), 
                                          by = .(mr_no, presc, prescdis, Type_med, Coded_med, 
                                                 Code, description, baseage, age, V263Roga, 
...
fwrite(a01all, 
       "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_repeat_prop_cumulative_Rcal_v263_roga.csv")

saveRDS (a01all, "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_repeat_prop_cumulative_Rcal_v263_roga.rds")
...
fwrite(dismed02, 
       "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_bymr_no_dismed_comb_Rcal_v263_roga.csv")

saveRDS (dismed02, "D:/Hospital_data/ProgresSQL/analysis_v263/080_medicine_bymr_no_dismed_comb_Rcal_v263_roga.rds")
