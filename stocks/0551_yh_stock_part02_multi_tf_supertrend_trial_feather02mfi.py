...
stock_final05 = feather.read_dataframe("D:/My-Shares/analysis/0551_5min_data_mfi_stin.feather")

stock_final05_2 = pd_ta.supertrend(stock_final05["mfi09h05"], stock_final05["mfi09l05"], stock_final05["mfi09c05"], length=supertrend_period, multiplier=supertrend_multiplier)
...
feather.write_dataframe(stock_final05, "D:/My-Shares/analysis/0551_5min_data_mfi_stout.feather")

stock_final15 = feather.read_dataframe("D:/My-Shares/analysis/0551_15min_data_mfi_stin.feather")

stock_final15_2 = pd_ta.supertrend(stock_final15["mfi09h15"], stock_final15["mfi09l15"], stock_final15["mfi09c15"], length=supertrend_period, multiplier=supertrend_multiplier)
...
feather.write_dataframe(stock_final15, "D:/My-Shares/analysis/0551_15min_data_mfi_stout.feather")

stock_final30 = feather.read_dataframe("D:/My-Shares/analysis/0551_30min_data_mfi_stin.feather")

stock_final30_2 = pd_ta.supertrend(stock_final30["mfi09h30"], stock_final30["mfi09l30"], stock_final30["mfi09c30"], length=supertrend_period, multiplier=supertrend_multiplier)
...
feather.write_dataframe(stock_final30, "D:/My-Shares/analysis/0551_30min_data_mfi_stout.feather")

#stock_final60 = feather.read_dataframe("D:/My-Shares/analysis/0551_60min_data_stin.feather")
